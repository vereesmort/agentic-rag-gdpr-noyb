    ...
    try:
        ...
        if summary_idx:
            sum_res = requests.get(API_URL, params={
                "action": "parse", "page": title, "section": summary_idx, "prop": "text", "format": "json"
            }).json()
...
def run_weekly_job():
    ...
    list_params = {
        "action": "query", "list": "recentchanges", "rcstart": start_time,
        "rcdir": "newer", "rctype": "new", "rcnamespace": "0", "rclimit": "500", "format": "json"
    }
    ...
    try:
        ...
        exit(1)  #Notify GH Actions of failure
